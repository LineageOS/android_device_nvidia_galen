...
$(call intermediates-dir-for,EXECUTABLES,nv_bootloader_payload_updater.product)/nv_bootloader_payload_updater: $(TARGET_OUT_PRODUCT_ETC)/firmware/bl_update_payload $(TARGET_OUT_PRODUCT_ETC)/firmware/kernel_only_payload
endif
