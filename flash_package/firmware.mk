...
$(_galen_br_bct): $(INSTALLED_CBOOT_TARGET) $(INSTALLED_KERNEL_TARGET) | $(ACP)
	@mkdir -p $(dir $@)
...
$(_rey_emmc_br_bct): $(INSTALLED_CBOOT_TARGET) $(INSTALLED_KERNEL_TARGET) | $(ACP)
	@mkdir -p $(dir $@)
...
$(_rey_sd_br_bct): $(INSTALLED_CBOOT_TARGET) $(INSTALLED_KERNEL_TARGET) | $(ACP)
	@mkdir -p $(dir $@)
...
$(_galen_blob): $(_galen_br_bct) $(_rey_sd_br_bct) $(_rey_emmc_br_bct) $(INSTALLED_KERNEL_TARGET) | $(ACP)
	@mkdir -p $(dir $@)
